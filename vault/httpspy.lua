...
pconsole(format("Find The log in workspace in synapse folder) Logs are automatically being saved", version, RecentCommit, options.SaveLogs and logname or "(You aren't saving logs, enable SaveLogs if you want to save logs)"));
